...
class PokemonCatchWorker:
    ...
    def _use_berry(self, berry_id, berry_count, encounter_id, catch_rate_by_ball, current_ball):
        ...
        response_dict = self.pogoservice.do_use_item_encounter(
            item=berry_id,
    ...
    def do_catch(self, encounter_id, catch_rate_by_ball, inventory, is_vip=False):
        berry_id = ITEM_PINAPBERRY
        berry_id = ITEM_RAZZBERRY

        maximum_ball = ITEM_ULTRABALL
        berry_count = inventory.get(berry_id)
        ...
        while True:
            ...
            response_dict = self.pogoservice.do_catch_pokemon(
                encounter_id=encounter_id,
            ...
            # pokemon caught!
                ...
                if self.rest_completed:
                    self.rest_completed = False
                pokemon_unique_id = response_dict['responses']['CATCH_POKEMON']['captured_pokemon_id']

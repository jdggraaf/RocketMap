...
lures_account_manager = AccountManager(args.lures_owner if args.lures_owner else args.system_id + "Lures",
                                       args.use_account_db, args, [], [], Queue(), {})
account_manager.initialize(args.lures_accountcsv, ())
...
def lure_positions(positions):
    ...
    lw = LureWorker(lures_account_manager, brander, lambda lure_dropped: datetime.now() > end_at)

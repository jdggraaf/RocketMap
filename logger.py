...
from gymdbsql import set_args, make_gym_map, member_list, defender_list, make_gym_map_v2
...
def asString(gymparticipant):
  first = gymparticipant["trainer_name"].encode('utf-8') + ", " + str(gymparticipant["last_modified"]) + ", "
  second = str(gymparticipant["latitude"]) + ", " + str(gymparticipant["longitude"]) + ", "
  gym_name = gymparticipant["name"].encode('utf-8')

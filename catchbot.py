...
class CatchBot():
    ...
    def reset(self):
        self.account_manager = AccountManager(self.instance_name, True, self.accounts_filename, (), self.args, [], [],
                                              Queue(), {})
        self.worker_manager = WorkerManager(self.account_manager, 25, 9)

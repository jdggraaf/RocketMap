...
from feedworker import FeedWorker, berry_location
...
threads = []
for loc in locs:
    the_thread = berry_location(loc, FeedWorker(account_manager, termination_condition, args.trainers, args.heavy_defense))
    time.sleep(10)
